...
| **6.B-3** | Check to see that the aria-hidden is set to "true".| True |
| **Result** | If all of the above checks fail, then Baseline Test 6.B-DecorativeImage fails. | PASS; the third check passed. |
