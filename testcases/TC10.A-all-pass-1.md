---
layout: testcase
title: Form Names - accessible name from placeholder attribute
tcid: TC10.A-all-pass-1
tc-version: "1"
...
result: PASS
result-descr: The input element in the code sample provides an accessible name value via implementation of the placeholder attribute.
sample: /testfiles/TF10/10.A-all-pass-1.html
---
...
| **10.A-1** | Check that the combination of the accessible name and accessible description is not empty. [SC 4.1.2] | The output for the accessible name and accessible descriptions computations is populated via the value of the placeholder text. | 
