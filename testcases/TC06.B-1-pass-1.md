...
| **6.B-1** | The ARIA role is "presentation". | True |
| **Result** | If all of the above checks fail, then Baseline Test 6.B-DecorativeImage fails | PASS; the first check passed.
