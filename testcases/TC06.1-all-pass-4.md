...
descr: | 
    ...
    The code sample provides an equivalent description of the image in an `aria-labelledby` attribute. A successful test should identify a PASS against Baseline 6.1 Meaningful Images.
...
result-descr: The image in the code sample has a descriptive accessible name from its `aria-labelledby` attribute.
