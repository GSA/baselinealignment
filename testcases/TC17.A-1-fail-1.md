...
| **17.A-1** | Check that user controls for the selection of captions and audio descriptions are provided. [Section 508 503.4] | Fail, no controls for captions or for audio descriptions |
| **Result** | If any of the above checks fail, then Baseline Requirement 17.A-MediaPlayerCCADControls fails. | Fail |