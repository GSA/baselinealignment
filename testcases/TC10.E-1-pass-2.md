...
| 10.E-1 | Check that each form component has label(s) or instructions. [SC 3.3.2]  | Pass. There is a brief prompt that tells you what to type in the form component. |