...
| Test Results | If any of the above checks fail, then Baseline Test 6.C-Captcha fails. | PASS: The text alternative identifies a CAPTCHA test. An alternative form of CAPTCHA is provided for users without vision and for users without hearing. |
