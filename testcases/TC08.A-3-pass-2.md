...
| 8.A-1 | Determine the contrast ratio of foreground text and background. | Contrast ratio is 4:1 |
| 8.A-2 | Check that the contrast ratio is at least 4.5:1. [SC 1.4.3] | Fail - the contrast ratio is less than 4.5:1 | 
...
| Results | If both of the above checks fail, then Baseline Test 8.A-ContrastMinimum fails. | Pass - the text in the sample code passes one of the checks in Baseline 8.A-ContrastMinimum|
