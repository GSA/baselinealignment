...
| 14.A-1 | Check that the combination of accessible name and accessible description is not empty. [SC 4.1.2] | Pass - each link provides an accessible name and description. |
...
| Result | If any of the above checks passes, then Baseline Test 14.A-Links. | Pass - all checks pass. | 
