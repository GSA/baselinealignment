...
# Baseline test
descr: |
    This form has a form component with a descriptive prompt before it, it passes 10.5
...
result-descr: |
    The form component is labeled with a descriptie label, instead of a basic prompt.
...
| 10.5-1 | Check that each form component has label(s) or instructions. [SC 3.3.2]  | Pass. There is a descriptive prompt that tells you what is needed in the form component. |