...
sample: /testfiles/TF15/15.A-3-fail-1.html
---
...
| **15.A-2** | Check that the lang attribute is defined on the `<html>` tag for the page. [SC 3.1.1] | Pass: `<html lang="eng">` |
