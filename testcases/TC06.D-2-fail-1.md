...
title: '6.D Images of Text - FAIL: image of text cannot be customized for font'


# The Test Case ID should follow the pattern: 
# TC[Baseline Test Procedure #]-[Test Instruction #]-
# [Expected Result (pass/fail/dna)]-[example #], e.g., TC05.1-1-fail-1
tcid: TC06.D-2-fail-1
...
app-baseline: | 
    [6.D Test Procedure for Images of Text](https://github.com/Section508Coordinators/ICTTestingBaseline/blob/section508coordinators301/06Images.md#64-test-procedure-for-images-of-text)

    **Baseline Test ID:** 6.D Test Procedure for Images of Text
...
sample: /testfiles/TF06/06.D-2-fail-1.html
