...
sample: /testfiles/TF13/13.D-2-fail-1.html
---
...
| **13.D-2** | For each visually apparent list: Check that content that has the visual appearance of a numbered list is marked as an ordered list. [SC 1.3.1] | Fail - the visually apparent ordered list is not defined programatically as a list. |
