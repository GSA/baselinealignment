...
| 8.A-1 | Determine the contrast ratio of foreground text and background. | The contrast ratio for all of the text on the page is at least 4.5:1 or greater. | 
| 8.A-2 | Check that the contrast ratio is at least 4.5:1. [SC 1.4.3] | The contrast ratio for all of the text on the page is at least 4.5:1 or greater. |
| Results | If both of the above checks pass, then Baseline Test 8.A-ContrastMinimum fails. | Pass |