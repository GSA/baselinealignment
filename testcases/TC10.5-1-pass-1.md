...
# Baseline test
descr: |
    This form has a form component with a clear label, it passes standard 10.5
...
| 10.5-1 | Check that each form component has label(s) or instructions. [SC 3.3.2]  | Pass. There is a prompt for the form component. | 