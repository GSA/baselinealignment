...
sample: /testfiles/TF06/06.A-all-pass-3.html
---
...
| **6.A-1** | Check that the text alternative (combination of the accessible name and accessible description) is not empty. [SC 1.1.1] | Pass: The image's non-empty accessible name from `aria-label` is "Bland Corp. logo". | 
