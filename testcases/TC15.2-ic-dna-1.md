...
title: Language of Parts - Not Applicable
...
descr: | 
    ...
    The code sample provides a page that is only in English. A successful test should identify a DOES NOT APPLY for Baseline 15.2-LanguagePart.
