...
sample: /testfiles/TF06/06.A-5-fail-1.html
---
...
| **6.A-5** | Check that aria-hidden is NOT set to "true". | Fail |
| **Result** | If any of the above checks fail, then Baseline Test 6.A-MeaningfulImage fails. | 6.A-5 check fails. |