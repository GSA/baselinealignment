...
| **13.B-1.a** | The most important heading(s) should have the highest priority level. For example, <code><h1></code> is a higher level than <code><h2></code>, which is higher than <code><h3></code>. | Fail: <code><h4> Periods of Classical Music </h4></code> should be higher than its <code><h3></code> subheadings. |
| **Result** | If the above check fails, then Baseline Test 13.B-VisHeadingProg fails. | FAIL; 13.B-1a fails |
