...
| 6.C-1 | Check that the text alternative (combination of the accessible name and accessible description) is not empty. `[`SC 1.1.1`]` | FAIL: The text alternative of the image is empty |
| Test Results | If any of the above checks fail, then Baseline Test 6.C-Captcha fails. | FAILL: The text alternative of the image is empty |
