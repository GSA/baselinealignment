...
title: 6.4 Images of Text - FAIL: image of text that could easily be just text 
...
sample: /testfiles/TF1/TC6.4-1-fail-1.html
...
| FAIL; page has an image of text that could easily be just text. |