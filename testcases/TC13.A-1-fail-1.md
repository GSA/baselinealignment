...
| **13.A-1** | Check that each heading describes the topic or purpose of its content. | False |
| **Result** | If the above check fails, then Baseline Test 13.A-HeadingDescriptive fails. | FAIL. |
